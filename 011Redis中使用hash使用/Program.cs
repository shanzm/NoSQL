    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (ConnectionMultiplexer redis = ConnectionMultiplexer.Connect("127.0.0.1:6379"))
            {
                ...
                db.HashSet("Person_id="+p1.Id.ToString(), p);

                var p1Name = db.HashGet("Person_id=" + p1.Id.ToString(), "Name");//第一个参数是hash的key,第二个参数是hashEntry中的Name元素
